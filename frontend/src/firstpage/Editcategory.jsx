...
function Editcategory() {
  return (
    <div>
        ...
        <div className='flex justify-between'>
          ...
          <h2 className="text-lg font-semibold mb-4">
            <button className='mr-4'><FaArrowLeft /></button>Edit Category</h2>
          <form >
    ...
    <label class="block text-muted-foreground mb-1" for="status">Status</label>
    <select id="status" class="border border-border rounded-md p-2 w-full">
